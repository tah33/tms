...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <br>
            <li><a href="{{url('password')}}"><i class="glyphicon glyphicon-asterisk"></i><span>Change Password</span></a></li>
            <br><ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{url('permissions')}}"><img src="{{url('public/roles.svg')}}" height="21"
                                                                      width="21">Roles</a></li>
                        </ul>
                    </li>
                @endif
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('teams/create')}}"><img src="{{asset('public/teams.svg')}}" height="21"
                                                                       width="21">Create Team</a></li>
                            @endcan
                            @can('viewAny', App\Team::class)
                                <li><a href="{{url('teams')}}"> <img src="{{asset('public/team.svg')}}" height="21"
                                                                     width="21">Teams</a></li>
                            @endcan
                        </ul>
                    </li>
                    @if(!Auth::user()->hasRole('member'))
                        @can('viewAny', App\Project::class)
                            <li><a href="{{url('projects')}}"><i style="font-size:15px" class="fa fa-check"></i><span>Projects</span></a>
                            </li>
                        @endcan
